...
from .models import SourceType, ContentCategory, QualityLevel
...
def register_source_tools(mcp_server):
    ...
    async def get_source_details(
        ...
        try:
            ...
            source = await _source_manager.get_source(
                source_id,
    ...
    async def delete_source(
        ...
        try:
            ...
            result = await _source_manager.delete_source(
                source_id,
                remove_chunks=remove_content
            )
    ...
    @mcp_server.tool()
    async def detect_source_relationships(
        source_id: str,
        rescan: bool = False
    ) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            relationships = await _source_manager.detect_relationships(
                source_id,
                rescan=rescan
            )
    ...
    async def blend_flavor_sources(
        ...
        try:
            ...
            result = await _source_manager.blend_flavor_sources(
                source_ids,
                weights
            )
