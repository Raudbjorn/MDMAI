...
class SourceManager:
    ...
    async def add_source(
        ...
        try:
            ...
            if source.metadata.source_type in [SourceType.FLAVOR, SourceType.ADVENTURE, SourceType.SETTING]:
    ...
    async def delete_source(
        ...
        try:
            ...
            if remove_chunks:
                ...
                await self.db.delete_documents(
                    collection_name='flavor_sources',
                    where={'source_id': source_id}
                )
    ...
    async def blend_flavor_sources(
        ...
        try:
            ...
            blended = self.flavor_integrator.blend_flavor_sources(
                sources,
                weights
            )
    ...
    async def _process_source(self, source: Source) -> Dict[str, Any]:
        ...
        if not self.pdf_pipeline:
            return {
                'success': False,
                'error': 'PDF pipeline not available'
            }
