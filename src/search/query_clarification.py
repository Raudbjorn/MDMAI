...
class QueryClarificationService:
    ...
    def __init__(self):
        ...
        self.ambiguous_terms = {
            ...
            "attack": ["attack action", "attack roll", "attack bonus", "melee attack", "ranged attack"],
        ...
        self.clarification_patterns = [
            ...
            (r'\bhow\s+(?:do|does|to)\b', "instruction", "Do you want rules explanation or examples?"),
            (r'\bbest\b', "optimization", "Are you looking for optimization advice or rules clarification?"),
            (r'\bvs\.?\b|\bversus\b', "comparison", "Would you like a detailed comparison or quick differences?"),
        ]
        
        # Track clarification history for learning
        self.clarification_history = []
        
    def detect_ambiguity(self, query: str, search_context: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        """
        ...
        for pattern, pattern_type, clarification_prompt in self.clarification_patterns:
            ...
            if match:
                ...
                clarification_needed.append({
                    ...
                    "prompt": clarification_prompt.format(*match.groups()) if match.groups() else clarification_prompt
                })
        ...
        if search_context:
            if not search_context.get("rulebook") and not search_context.get("system"):
                ...
                clarification_needed.append({
                    "type": "missing_system",
                    "prompt": "Which game system are you asking about?"
                })
    ...
    def learn_from_feedback(
        self,
        query: str,
        clarification_used: Dict[str, Any],
    ...
    def _generate_content_suggestions(self, query: str, available_content: List[str]) -> List[str]:
        ...
        # Sort by relevance
        suggestions.sort(key=lambda x: difflib.SequenceMatcher(None, query_lower, x.lower()).ratio(), reverse=True)
    ...
    def _extract_related_queries(self, query: str, search_results: List[Dict[str, Any]]) -> List[str]:
    ...
    def _analyze_clarification_patterns(self) -> None:
        ...
        successful_clarifications = [
            h for h in self.clarification_history
            if h.get("quality", 0) > 0.7
        ]
