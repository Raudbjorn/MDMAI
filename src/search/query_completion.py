...
class QueryTrie:
    ...
    def _collect_completions(self, node: TrieNode, prefix: str, completions: List[Tuple[str, int]]) -> None:
...
class QueryCompletionEngine:
    ...
    def get_completions(
        ...
        with self.lock:
            ...
            if pattern:
                pattern_completions = self.pattern_matcher.get_pattern_completions(pattern, partial_lower)
