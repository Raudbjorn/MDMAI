...
class NPCGenerator:
    ...
    ROLE_PERSONALITY_TRAITS = {
        NPCRole.MERCHANT: {
            ...
            "quirk": ["haggles everything", "knows everyone", "suspicious of nobles", "loves gossip"]
        },
        NPCRole.GUARD: {
        ...
        NPCRole.SCHOLAR: {
            ...
            "quirk": ["terrible memory for names", "obsessed with topic", "speaks in quotes", "messy"]
        },
        NPCRole.CRIMINAL: {
        ...
        NPCRole.ARTISAN: {
            ...
            "quirk": ["never satisfied", "rival artisan", "secret technique", "artistic temperament"]
        },
        NPCRole.COMMONER: {
    ...
    ROLE_KNOWLEDGE = {
        ...
        NPCRole.NOBLE: ["court intrigue", "family histories", "political alliances", "social customs"],
        ...
        NPCRole.ADVENTURER: ["dungeon locations", "monster lore", "treasure rumors", "survival tips"],
        NPCRole.ARTISAN: ["craft techniques", "material sources", "guild politics", "customer preferences"],
        NPCRole.COMMONER: ["local gossip", "daily life", "town personalities", "practical skills"],
        NPCRole.SOLDIER: ["military tactics", "enemy movements", "fortifications", "command structure"],
        NPCRole.MAGE: ["magical theory", "spell components", "planar knowledge", "ancient artifacts"],
    ...
    def generate_npc(
        ...
        npc.personality_traits = self._generate_personality_traits(
            npc.role,
            personality_traits
        )
    ...
    def _generate_personality_traits(
        ...
        if custom_traits:
            ...
            trait_pool = self.ROLE_PERSONALITY_TRAITS.get(
                role,
                self.ROLE_PERSONALITY_TRAITS[NPCRole.COMMONER]
            )
    ...
    def _set_behavioral_attributes(self, npc: NPC):
        ...
        # Combat behavior
        npc.combat_behavior = self.ROLE_COMBAT_BEHAVIOR.get(
            npc.role,
            "defensive"
        ).capitalize()
        ...
        elif any(t.trait in ["professional", "disciplined", "business-minded"] for t in npc.personality_traits):
