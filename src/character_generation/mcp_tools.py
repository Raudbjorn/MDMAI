...
def register_character_tools(mcp_server):
    ...
    async def generate_npc(
        ...
        try:
            ...
            return {
                "success": False,
                "error": f"NPC generation failed: {str(e)}"
            }
    ...
    async def generate_character_backstory(
        ...
        try:
            ...
            if not _backstory_generator:
                return {
                    "success": False,
                    "error": "Backstory generator not initialized"
                }
            ...
            backstory = _backstory_generator.generate_backstory(
                ...
                hints=hints,
                depth=depth,
                use_flavor_sources=use_flavor_sources
            )
            ...
            return {
                "success": False,
                "error": f"Backstory generation failed: {str(e)}"
            }
    ...
    async def list_generated_npcs(
        ...
        try:
            ...
            return {
                "success": False,
                "error": f"Failed to list NPCs: {str(e)}"
            }
