...
class ResponseGenerator:
    ...
    def __init__(self, personality_manager: Optional[PersonalityManager] = None):
        ...
        self.tone_templates = {
            "authoritative": {
                "prefix": ["According to the rules,", "The regulations state that", "It is mandated that"],
                "suffix": ["This is non-negotiable.", "No exceptions are permitted.", "This must be followed."],
                "connectors": ["therefore", "thus", "consequently", "hence"],
            },
            "mysterious": {
                "prefix": ["Perhaps...", "One might wonder if", "It is whispered that"],
                "suffix": ["...or so the legends say.", "...but who can truly know?", "...shrouded in mystery."],
                "connectors": ["yet", "however", "although", "perhaps"],
            },
            "scholarly": {
                "prefix": ["Research indicates that", "Studies have shown", "Analysis reveals"],
                "suffix": ["Further investigation is warranted.", "This conclusion is well-supported.", "The evidence is compelling."],
            ...
            "military": {
                ...
                "suffix": ["Mission parameters defined.", "Proceed with caution.", "Maintain operational security."],
    ...
    def _apply_sentiment(self, text: str, sentiment: Dict[str, float]) -> str:
        ...
        if mood == "positive":
            ...
            negative_words = ["concerning", "problematic", "difficult", "challenging", "unfortunate"]
    ...
    def _insert_modifiers(self, text: str, modifiers: List[str], probability: float) -> str:
        ...
        for word in words:
            ...
            if random.random() < probability:
                ...
                if not word.lower() in ["the", "a", "an", "and", "or", "but", "in", "on", "at", "to", "for"]:
