...
class Settings(BaseSettings):
    ...
    # Voice Synthesis
    voice_provider: str = Field(default="ollama_tts", env="VOICE_PROVIDER")
    elevenlabs_api_key: Optional[str] = Field(default=None, env="ELEVENLABS_API_KEY")
    fish_audio_api_key: Optional[str] = Field(default=None, env="FISH_AUDIO_API_KEY")
    ollama_tts_url: str = Field(default="http://localhost:8880", env="OLLAMA_TTS_URL")
    voice_cost_limit_usd: float = Field(default=5.0, env="VOICE_COST_LIMIT_USD")
