<script lang="ts">
  ...
  // Tab state
  let activeTab = $state<'configuration' | 'costs' | 'analytics'>(
    'configuration'
  );
  ...
  {:else}
    ...
    <div class="flex gap-2 border-b border-gray-200 dark:border-gray-700">
      <button
        ...
        class="px-4 py-2 text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 border-b-2 border-transparent transition-colors {activeTab ===
        'configuration'
        ...
        <div class="configuration-tab">
          <div class="mb-6">
            ...
            <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">
              Set up API keys, configure settings, and manage provider
              priorities
            </p>
          </div>
